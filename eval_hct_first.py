...
server_dict = {
    'mini':{
        'dataset': 'mini',
        'data_path': '/Volumes/easystore/zzprojects/fslcoral/mini-imagenet',     # Need to modify here
        'ckp_path': '/Volumes/easystore/zzprojects/fslcoral/HCTransformers/checkpoints_first/'},   # Need to be passed in commandline args
    'fs':{
        'dataset': 'fs',
    ...
    'fc100':{
        'dataset': 'fc100',
        'data_path': '/Volumes/easystore/zzprojects/fslcoral/FC100/',
        'ckp_path': '/Volumes/easystore/zzprojects/fslcoral/HCTransformers/checkpoints_first/'},
    'tiered':{
        'dataset': 'tiered',
    ...
    for i in range(len(checkdir)):
        ...
        if '.pth' in checkdir[i]:
            ...
            if not checkdir[i][-8:-4].isdigit():
                epoch = int(torch.load(args.pretrained_weights, map_location =device)['epoch']) - 1
            else:
            ...
            outfile = os.path.join(args.output_dir,'{}_224_{}_{}.hdf5'.format(args.partition,epoch, args.checkpoint_key))
...
if __name__ == '__main__':
    ...
    # setup ckp_path
    if args.ckp_path == '':
        args.ckp_path = '/Volumes/easystore/zzprojects/fslcoral/HCTransformers/checkpoints_first/'
