...
def train_dino(args):
    ...
    if device.type == 'cuda':
        ...
        surrogate_loss1 = SurrogateLoss(args.local_crops_number + 2, feat_dim=8192, num_classes=64)
        surrogate_loss2 = SurrogateLoss(args.local_crops_number + 2, feat_dim=384, num_classes=64)
...
class SurrogateLoss(nn.Module):
    ...
    """
    def __init__(self, ncrops, num_classes=64, feat_dim=8192, use_gpu=True):
